			...
			<div class="col-md-12 vcenter sim-info mt-3">
				...
				<tr>
					...
					<?php
						global $nhaMang;
					?>
					<a data-toggle="collapse" href="#collapse-nha-mang" role="button" aria-expanded="false" aria-controls="collapse-nha-mang" title="<?php echo ucfirst($nhaMang); ?>" href="<?php echo home_url('/') . strtolower($nhaMang)?>"><?php echo ucfirst($nhaMang) ?> <span style="color: #c4161c;font-size: 15px;font-weight: initial;">(giới thiệu)</span></a>
					</td>
				</tr>
				...
				<tr>
					...
					<?php if ($loaithuebao == 'tt') echo 'Trả trước';
						...
						else echo 'Không xác định'; ?> <span style="color: #c4161c;font-size: 15px; font-weight: initial;">(thông tin)</span></a>
					</td>
				</tr>
				...
				<tr>
					...
					<?php
						...
						?>
						<a data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample" title="<?php echo $goicuoc ?>" href="<?php echo home_url('/') . strtolower($goicuoc)?>"><?php echo $goicuoc ?> <span style="color: #c4161c;font-size: 15px;font-weight: initial;">(khuyến mãi)</span></a>
				...
				<div class="accordion" id="accordionExample">
					...
					<div class="collapse show" id="collapseExample" style="font-weight: initial;" data-parent="#accordionExample">
						<div class="card card-body">
							<?php
