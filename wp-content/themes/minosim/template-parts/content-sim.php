...
<tr id="post-<?php the_ID(); ?>">
	...
	<td class="align-middle d-md-table-cell network-td">
	    <?php
	...
	<td class="align-middle">
		<a class="btn btn-primary btn-sm" href="<?=get_the_permalink()?>"><span class="d-none d-md-inline">ĐẶT </span>MUA</a>
	</td>
</tr>