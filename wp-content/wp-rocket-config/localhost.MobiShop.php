...
$rocket_cookie_hash = '03c46ead6b6eded592634e2238cca1b0';
$rocket_logged_in_cookie = 'wordpress_logged_in_03c46ead6b6eded592634e2238cca1b0';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_cache_reject_uri = '/MobiShop(/(.+/)?feed/?|/(?:.+/)?embed/|/(index\.php/)?wp\-json(/.*|$))';
