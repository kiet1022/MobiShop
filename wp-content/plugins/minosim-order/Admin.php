...
class MinoSimOrderAdmin
{
    ...
    public function set_columns($columns)
    {
        $columns = array(
            ...
            'order_mang' => __('Mạng', 'mino-order'),
            'order_goi_cuoc' => __('Gói cước', 'mino-order'),
            'order_price' => __('Giá', 'mino-order'),
            'order_agency_name' => __('Giá', 'mino-order'),
    ...
    function save_order($post_id ) {
        ...
        if ( isset( $_POST['order_mang'] ) )
            update_post_meta( $post_id, 'order_mang', esc_attr( $_POST['order_mang'] ) );
        if ( isset( $_POST['order_goi_cuoc'] ) )
            update_post_meta( $post_id, 'order_goi_cuoc', esc_attr( $_POST['order_goi_cuoc'] ) );
    }
